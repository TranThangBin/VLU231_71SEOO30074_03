...
CREATE TABLE Admin (
	Ma VARCHAR(20) PRIMARY KEY,
	MaTk INT UNIQUE FOREIGN KEY REFERENCES TaiKhoan(Ma),
	HoTen NVARCHAR(50),
	NgaySinh DATE,
	QueQuan NVARCHAR(50),
	GioiTinh BIT,
...
CREATE TABLE GiangVien (
	Ma VARCHAR(20) PRIMARY KEY,
	MaKhoa VARCHAR(20) FOREIGN KEY REFERENCES Khoa(Ma),
	MaTk INT UNIQUE FOREIGN KEY REFERENCES TaiKhoan(Ma),
	HoTen NVARCHAR(50),
	NgaySinh DATE,
	QueQuan NVARCHAR(50),
...
CREATE TABLE LopHp (
	Ma VARCHAR(20) PRIMARY KEY,
	MaMonHoc VARCHAR(20) FOREIGN KEY REFERENCES MonHoc(Ma),
)
